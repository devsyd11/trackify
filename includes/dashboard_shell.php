 ...
 * @param string $navActive   trackify | phone | ip | exiftool | fbmonitor | igmonitor | settings
...
<body class="dashboard-shell-body">
    <div class="app-shell">
        <nav class="side-nav" aria-label="Main navigation">
            ...
            <div class="side-nav-group<?= ($navActive === 'fbmonitor' || $navActive === 'igmonitor') ? ' has-active-child' : '' ?>">
                ...
                <div class="side-nav-submenu" role="group" aria-label="Meta tools">
                    ...
                    <a href="panel.php?view=igmonitor" class="side-nav-item side-nav-item--sub<?= $navActive === 'igmonitor' ? ' active' : '' ?>" title="Instagram checker">
                        <span class="side-nav-item-icon" aria-hidden="true">
                            <svg class="side-nav-ig-logo" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                                <defs>
                                    <linearGradient id="shellNavIgGrad" x1="0%" y1="100%" x2="100%" y2="0%">
                                        <stop offset="0%" stop-color="#FFDC80"/>
                                        <stop offset="45%" stop-color="#E1306C"/>
                                        <stop offset="100%" stop-color="#833AB4"/>
                                    </linearGradient>
                                </defs>
                                <path fill="url(#shellNavIgGrad)" d="M12 2.2c3.2 0 3.6.1 4.9.1 1.2.1 1.9.3 2.4.5.6.2 1 .5 1.5 1s.8.9 1 1.5c.2.6.4 1.2.5 2.4.1 1.3.1 1.7.1 4.9s-.1 3.6-.1 4.9c-.1 1.2-.3 1.9-.5 2.4-.2.6-.5 1-1 1.5s-.9.8-1.5 1c-.5.2-1.2.4-2.4.5-1.3.1-1.7.1-4.9.1s-3.6-.1-4.9-.1c-1.2-.1-1.9-.3-2.4-.5-.6-.2-1-.5-1.5-1s-.8-.9-1-1.5c-.2-.5-.4-1.2-.5-2.4-.1-1.3-.1-1.7-.1-4.9s.1-3.6.1-4.9c.1-1.2.3-1.9.5-2.4.2-.6.5-1 1-1.5s.9-.8 1.5-1c.5-.2 1.2-.4 2.4-.5 1.3-.1 1.7-.1 4.9-.1zm0 1.8c-3.2 0-3.5.1-4.8.1-1.1.1-1.8.2-2.2.4-.5.2-.9.5-1.3.9-.4.4-.7.8-.9 1.3-.2.4-.3 1.1-.4 2.2-.1 1.3-.1 1.6-.1 4.8s0 3.5.1 4.8c.1 1.1.2 1.8.4 2.2.2.5.5.9.9 1.3.4.4.8.7 1.3.9.4.2 1.1.3 2.2.4 1.3.1 1.6.1 4.8.1s3.5 0 4.8-.1c1.1-.1 1.8-.2 2.2-.4.5-.2.9-.5 1.3-.9.4-.4.7-.8.9-1.3.2-.4.3-1.1.4-2.2.1-1.3.1-1.6.1-4.8s0-3.5-.1-4.8c-.1-1.1-.2-1.8-.4-2.2-.2-.5-.5-.9-.9-1.3-.4-.4-.8-.7-1.3-.9-.4-.2-1.1-.3-2.2-.4-1.3-.1-1.6-.1-4.8-.1zm0 4.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zm0 9a3.5 3.5 0 110-7 3.5 3.5 0 010 7zm7-9.1a1.3 1.3 0 11-2.6 0 1.3 1.3 0 012.6 0z"/>
                            </svg>
                        </span>
